...
1. Navigate to [Report a Vulnerability](https://github.com/metadatastician/svalinn/security/advisories/new)
...
- This repository (`metadatastician/svalinn`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/metadatastician/svalinn/security/advisories)
...
When using Svalinn, we recommend:
...
- [Security Advisories](https://github.com/metadatastician/svalinn/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/metadatastician/svalinn/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/metadatastician/svalinn/discussions) |
